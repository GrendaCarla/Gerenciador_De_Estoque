...
public class TelaClienteAlterar extends javax.swing.JFrame {
    ...
    public void AlinhamentoDosItens() {
        ...
        int espacodata = (((largura - CentralizarLargura(116, 18,2)-180-15-20-20-20-20-45-15)- (CentralizarLargura(116, 18,2)+ 70 + 400 + 15 + 4)) / 2 + (CentralizarLargura(116, 18,2)+ 70 + 400 + 15 + 4)) - (60 + 170 + 15 + 15)/2;
        
        
        jLbDataDeNascimento.setBounds(largura - CentralizarLargura(116, 18,2)-180-15-20-20-20-20-40-15, CentralizarAltura(30, 120, 34),180 + 15 + 20 + 20 + 20 + 20 + 45 + 15,30);
